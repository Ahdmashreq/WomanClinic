...
class Patient(models.Model):
    ...
    job = models.CharField(max_length=30, verbose_name=_('Job'), blank=True, null=True)
    ...
    insurance_number = models.CharField(max_length=70, blank=True, null=True,verbose_name=_('Insurance Number'))
    entrance_number = models.PositiveIntegerField(blank=True, null=True,verbose_name=_('Enterance Number'))
    hospital_number = models.PositiveIntegerField(blank=True, null=True,verbose_name=_('Hospital Number'))
    patient_number = models.PositiveIntegerField(blank=True, null=True,verbose_name=_('Patient Number'))
    room = models.CharField(max_length=70, blank=True, null=True,verbose_name=_('Room'))
...
def save_barcode_image(sender, instance, **kwargs):
    ...
    file = open(f'{os.path.join(barcode_dir,bar_code_name)}.svg', 'r+')
